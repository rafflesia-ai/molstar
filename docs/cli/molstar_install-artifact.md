...
```
  ...
  -h, --help                      help for install-artifact
      ...
      --verify                    probe the installed runtime and fail if it cannot render (default true)
      --verify-timeout duration   timeout for the post-install capability probe (default 1m0s)
```
